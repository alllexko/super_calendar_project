...
// Shortcuts menu:
openerp.simbioz_theme_extend(function(instance) {

    var QWeb = instance.web.qweb,
        _t = instance.web._t;

    instance.simbioz_theme.Shortcuts = instance.web.Widget.extend({
        ...
        init: function() {
            ...
            this.model = new instance.web.Model('simbioz_theme.shortcut');
        },
        start: function() {
            var self = this;
            this._super();
        ...
        do_update: function() {
            ...
            this.update_promise.done(function() {
                if (self.shortcuts) {
                    ...
                    self.shortcuts = new instance.simbioz_theme.Shortcuts(self);
